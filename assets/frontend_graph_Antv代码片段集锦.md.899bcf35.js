import{_ as s,o as n,c as a,V as l}from"./chunks/framework.c6d8cbec.js";const u=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/graph/Antv代码片段集锦.md","filePath":"frontend/graph/Antv代码片段集锦.md"}'),p={name:"frontend/graph/Antv代码片段集锦.md"},o=l(`<h2 id="网络拓扑图代码" tabindex="-1">网络拓扑图代码 <a class="header-anchor" href="#网络拓扑图代码" aria-label="Permalink to &quot;网络拓扑图代码&quot;">​</a></h2><h3 id="图实例化" tabindex="-1">图实例化 <a class="header-anchor" href="#图实例化" aria-label="Permalink to &quot;图实例化&quot;">​</a></h3><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki dracula-soft vp-code-dark"><code><span class="line"><span style="color:#F286C4;">import</span><span style="color:#F6F6F4;"> { commonRegister ,viewRegister} </span><span style="color:#DEE492;">&#39;</span><span style="color:#E7EE98;">./registerElements.js</span><span style="color:#DEE492;">&#39;</span></span>
...
<span class="line"><span style="color:#E7EE98;">    combos,</span></span>
<span class="line"><span style="color:#E7EE98;">  });</span></span>
<span class="line"><span style="color:#E7EE98;">},</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#D73A49;">import</span><span style="color:#24292E;"> { commonRegister ,viewRegister} </span><span style="color:#032F62;">&#39;./registerElements.js&#39;</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#032F62;">    combos,</span></span>
<span class="line"><span style="color:#032F62;">  });</span></span>
<span class="line"><span style="color:#032F62;">},</span></span></code></pre></div><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki dracula-soft vp-code-dark"><code><span class="line"><span style="color:#62E884;">mounted</span><span style="color:#F6F6F4;">() {</span></span>
...
<span class="line"><span style="color:#24292E;">},</span></span></code></pre></div><h3 id="注册节点" tabindex="-1">注册节点 <a class="header-anchor" href="#注册节点" aria-label="Permalink to &quot;注册节点&quot;">​</a></h3><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki dracula-soft vp-code-dark"><code><span class="line"><span style="color:#7B7F8B;">//registerElements.js</span></span>
...
<span class="line"><span style="color:#F6F6F4;">}</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#6A737D;">//registerElements.js</span></span>
...
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div><h2 id="一、默认收缩二级节点" tabindex="-1">一、默认收缩二级节点 <a class="header-anchor" href="#一、默认收缩二级节点" aria-label="Permalink to &quot;一、默认收缩二级节点&quot;">​</a></h2><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki dracula-soft vp-code-dark"><code><span class="line"><span style="color:#7B7F8B;">//树形图哪个需要收缩则把属性collapsed设置为true</span></span>
<span class="line"><span style="color:#F6F6F4;">data.children.</span><span style="color:#62E884;">forEach</span><span style="color:#F6F6F4;">(</span><span style="color:#FFB86C;font-style:italic;">item</span><span style="color:#F6F6F4;"> </span><span style="color:#F286C4;">=&gt;</span><span style="color:#F6F6F4;"> item.collapsed </span><span style="color:#F286C4;">=</span><span style="color:#F6F6F4;"> </span><span style="color:#BF9EEE;">true</span><span style="color:#F6F6F4;">)</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#6A737D;">//树形图哪个需要收缩则把属性collapsed设置为true</span></span>
<span class="line"><span style="color:#24292E;">data.children.</span><span style="color:#6F42C1;">forEach</span><span style="color:#24292E;">(</span><span style="color:#E36209;">item</span><span style="color:#24292E;"> </span><span style="color:#D73A49;">=&gt;</span><span style="color:#24292E;"> item.collapsed </span><span style="color:#D73A49;">=</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">true</span><span style="color:#24292E;">)</span></span></code></pre></div><h2 id="二、改用iconfont文字不居中问题" tabindex="-1">二、改用iconfont文字不居中问题 <a class="header-anchor" href="#二、改用iconfont文字不居中问题" aria-label="Permalink to &quot;二、改用iconfont文字不居中问题&quot;">​</a></h2><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki dracula-soft vp-code-dark"><code><span class="line"><span style="color:#7B7F8B;">//注册节点添加label图形时动态计算label位置</span></span>
<span class="line"><span style="color:#F6F6F4;"> group.</span><span style="color:#62E884;">addShape</span><span style="color:#F6F6F4;">(</span><span style="color:#DEE492;">&quot;</span><span style="color:#E7EE98;">text</span><span style="color:#DEE492;">&quot;</span><span style="color:#F6F6F4;">, {</span></span>
<span class="line"><span style="color:#F6F6F4;">   attrs</span><span style="color:#F286C4;">:</span><span style="color:#F6F6F4;"> {</span></span>
<span class="line"><span style="color:#F6F6F4;">     x</span><span style="color:#F286C4;">:</span><span style="color:#F6F6F4;"> </span><span style="color:#BF9EEE;">0</span><span style="color:#F6F6F4;">,</span></span>
<span class="line"><span style="color:#F6F6F4;">     y</span><span style="color:#F286C4;">:</span><span style="color:#F6F6F4;"> </span><span style="color:#F286C4;">-</span><span style="color:#BF9EEE;">80</span><span style="color:#F6F6F4;">,</span></span>
<span class="line"><span style="color:#F6F6F4;">   textAlign</span><span style="color:#F286C4;">:</span><span style="color:#F6F6F4;"> </span><span style="color:#DEE492;">&quot;</span><span style="color:#E7EE98;">center</span><span style="color:#DEE492;">&quot;</span><span style="color:#F6F6F4;">,</span></span>
<span class="line"><span style="color:#F6F6F4;">   textBaseline</span><span style="color:#F286C4;">:</span><span style="color:#F6F6F4;"> </span><span style="color:#DEE492;">&quot;</span><span style="color:#E7EE98;">middle</span><span style="color:#DEE492;">&quot;</span><span style="color:#F6F6F4;">,</span></span>
<span class="line"><span style="color:#F6F6F4;">    text</span><span style="color:#F286C4;">:</span><span style="color:#F6F6F4;"> cfg.label,</span></span>
<span class="line"><span style="color:#F6F6F4;">   </span><span style="color:#F286C4;">...</span><span style="color:#F6F6F4;">labelStyle.style,</span><span style="color:#7B7F8B;">//这里需要重新处理x,y</span></span>
<span class="line"><span style="color:#F6F6F4;"> },</span></span>
<span class="line"><span style="color:#F6F6F4;">  name</span><span style="color:#F286C4;">:</span><span style="color:#F6F6F4;"> </span><span style="color:#DEE492;">&quot;</span><span style="color:#E7EE98;">hubCombo-label</span><span style="color:#DEE492;">&quot;</span><span style="color:#F6F6F4;">,</span></span>
<span class="line"><span style="color:#F6F6F4;">});</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#6A737D;">//注册节点添加label图形时动态计算label位置</span></span>
<span class="line"><span style="color:#24292E;"> group.</span><span style="color:#6F42C1;">addShape</span><span style="color:#24292E;">(</span><span style="color:#032F62;">&quot;text&quot;</span><span style="color:#24292E;">, {</span></span>
<span class="line"><span style="color:#24292E;">   attrs: {</span></span>
<span class="line"><span style="color:#24292E;">     x: </span><span style="color:#005CC5;">0</span><span style="color:#24292E;">,</span></span>
<span class="line"><span style="color:#24292E;">     y: </span><span style="color:#D73A49;">-</span><span style="color:#005CC5;">80</span><span style="color:#24292E;">,</span></span>
<span class="line"><span style="color:#24292E;">   textAlign: </span><span style="color:#032F62;">&quot;center&quot;</span><span style="color:#24292E;">,</span></span>
<span class="line"><span style="color:#24292E;">   textBaseline: </span><span style="color:#032F62;">&quot;middle&quot;</span><span style="color:#24292E;">,</span></span>
<span class="line"><span style="color:#24292E;">    text: cfg.label,</span></span>
<span class="line"><span style="color:#24292E;">   </span><span style="color:#D73A49;">...</span><span style="color:#24292E;">labelStyle.style,</span><span style="color:#6A737D;">//这里需要重新处理x,y</span></span>
<span class="line"><span style="color:#24292E;"> },</span></span>
<span class="line"><span style="color:#24292E;">  name: </span><span style="color:#032F62;">&quot;hubCombo-label&quot;</span><span style="color:#24292E;">,</span></span>
<span class="line"><span style="color:#24292E;">});</span></span></code></pre></div><h2 id="三、初始化画图完成后出现这个锯齿" tabindex="-1">三、初始化画图完成后出现这个锯齿 <a class="header-anchor" href="#三、初始化画图完成后出现这个锯齿" aria-label="Permalink to &quot;三、初始化画图完成后出现这个锯齿&quot;">​</a></h2>`,11),e=[o];function t(c,r,y,F,E,i){return n(),a("div",null,e)}const h=s(p,[["render",t]]);export{u as __pageData,h as default};
